...
int main(){ //exploring what and how we can work with strings cuz apparently CPP has that feature so why not
    ...
    cout << batman <<' '<< superman <<' '<< deadpool <<' '<< spiderman << "\n";
            ...
            string name=batman.append(superman),  
                   name0=spiderman.append(deadpool).append(batman); //so here we see you can also concatinate at the end of a string more than once
            cout << name << ' ' << name0 << "\n";
