...
int main() {
    int name;
    ("Enter the song number you want kyuki switch-case mein ints hi kar skte, string input ke liye alag header file or syntax chahiye\n");
    printf("1. Farebi (ChaarDiwaari)\n2. 11K (SeedheMaut)\n3. Lukka Chuppi\n Your Choice : ");
    scanf("%d", &name);

    switch(name) {
        case 1: printf("Okay, ready?\n"
        ...
        case 2: printf("[Intro: Calm]\n"
           ...
           "Bas aage badte jao\n"
           "Dhanyawaad\n"); break;
        default: printf("ITNE HI OPTIONS HAIN BHAI ABHI :_)\n");
}
return 0;
